...
<body>
    <div class="container">
        ...
        <main>
            ...
            <div class="links">
                ...
                <a href="https://github.com/dominikkolarsky/php-login-app_deploy">GitHub ›</a>
            </div>
            ...
            <div class="loginForm">
                ...
                <p>Pokud nejste registrován, můžete se <a href="registrace.php">registrovat zde</a>.</p>
            </div>
        </main>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql_allUsers = "SELECT * FROM login_app WHERE user_login = '$login' AND user_password = '$password'";
